...
insert into score (candidate_id, math, specific, project_plan  ) values ( '1', '76','58','21');
insert into score (candidate_id, math, specific, project_plan  ) values ( '2', '4','5','22');
insert into score (candidate_id, math, specific, project_plan  ) values ( '3', '15','59','12');
insert into score (candidate_id, math, specific, project_plan  ) values ( '4', '41','42','99');
insert into score (candidate_id, math, specific, project_plan  ) values ( '5', '22','90','9');
insert into score (candidate_id, math, specific, project_plan  ) values ( '6', '82','77','15');
insert into score (candidate_id, math, specific, project_plan  ) values ( '7','82', '99','56');
insert into score (candidate_id, math, specific, project_plan  ) values ( '8', '11','4','22');
insert into score (candidate_id, math, specific, project_plan  ) values ( '9', '16','29','94');
insert into score (candidate_id, math, specific, project_plan  ) values ( '10', '1','7','59');
